...
import { getPopularTV, getTopRatedTV, getMediaTitle } from '../services/tmdb';
...
export default function TV() {
  ...
  if (filter.trim()) tulemused = tulemused.filter(s => getMediaTitle(s).toLowerCase().includes(filter.toLowerCase()));
      ...
      <div style={s.tööriistariba}>
        ...
        <div style={{ display: 'flex', gap: '8px', marginLeft: 'auto' }}>
          <input type="text" value={filter} onChange={e => setFilter(e.target.value)}
            placeholder="Filtreeri nimetuse järgi..." style={s.input} />
